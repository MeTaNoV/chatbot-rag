=== Chatbot Ultra for WordPress ===
Contributors: Kognetiks
Tags: chatbot, chatgpt, openai, ai, customer-support, conversational chat, assistants, custom GPTs, quivr
...
== Introducing Chatbot Ultra for WordPress: Revolutionizing Digital Interactions ==

Welcome to the future of website interaction with **Chatbot Ultra for WordPress**, your gateway to unparalleled visitor engagement powered by the best chat provider including OpenAI's ChatGPT Large Language Models (LLMs), GPT Assistants and Quivr.

**🌐 Harnessing OpenAI's Large Language Models for Enhanced Engagement**
Dive into the world of advanced AI with OpenAI's Large Language Models at the core of our Chatbot Ultra. These models are trained to understand and respond to user queries in a natural, conversational manner. They're not just chatbots; they're intelligent conversational partners that can engage, inform, and assist your visitors in real time. Whether it's providing detailed answers to complex queries or engaging in casual conversation, these models are equipped to elevate the user experience on your website.
...
Discover more about these innovative features at [Kognetiks.com](https://kognetiks.com/wordpress-plugins/chatbot-ultra/chatbot-ultra-for-wordpress-assistants-and-custom-gpts/) and [OpenAI's Playground](https://platform.openai.com/assistants).

**🔄 Choose Your Style: Embedded or Floating Chatbots**
Flexibility is key. Display your Chatbot Ultra as an embedded feature on pages or let it float across your site. With simple shortcodes, adapt the chatbot's presence to match your website's design and user needs.
...
Chatbot Ultra is more than just a plugin – it's a transformational tool for your website. With advanced AI technology at its core, it promises a unique and interactive experience for your visitors.

Get Chatbot Ultra today and redefine your WordPress site with intelligence and a personal touch.
...
Visit us at [Kognetiks.com](https://kognetiks.com/wordpress-plugins/chatbot-ultra/) for more information.

**🌐 Features at a Glance**
▪ **Quick Setup:** Integrate easily with OpenAI's ChatGPT API and Quivr API.
...
== Experience the Evolution of Website Interaction with Chatbot Ultra for WordPress! ==
...
2. Install and activate the Chatbot Ultra plugin.
...
5. For a floating chatbot add the shortcode to your theme's footer: [chatbot_ultra provider=quivr] or [chatbot_ultra style=floating]
6. For an embedded chatbot on any page add the shortcode: [chatbot_ultra style=embedded]
7. Use [chatbot_ultra style=floating|embedded assistant=primary|alternate] to display the chatbot as a floating chatbot or embedded chatbot with a primary or alternate assistant.
...
**Installing Chatbot Ultra on Your WordPress Website**

Embark on a journey to elevate your website's interactivity with our Chatbot Ultra plugin. Here's how to get started:

1. **Plugin Upload**
   - Begin by downloading the 'chatbot-ultra' plugin folder.
   ...
   - Upload the 'chatbot-ultra' folder and click 'Install Now'.

2. **Plugin Activation**
   - Once the installation is complete, activate the plugin by clicking 'Activate Plugin'.

3. **API Key Configuration**
   - After activation, head to 'Settings > Chatbot Ultra' in your dashboard.
...
5. **Embedding the Chatbot**
   ...
   - Use the shortcode `[chatbot_ultra]` for a standard chatbot.
   - For a floating chatbot, use `[chatbot_ultra style=floating]`.
   - If you prefer an embedded chatbot, use `[chatbot_ultra style=embedded]`.

6. **Knowledge Navigator Setup**
   - To fully utilize the capabilities of Chatbot Ultra, go back to 'Settings > Chatbot Ultra' and click on the 'Knowledge Navigator' tab.
...
With Chatbot Ultra installed, you're now equipped to offer a more dynamic, engaging, and responsive experience to your website visitors.

== Frequently Asked Questions ==

= How do I obtain an API key for Ultra? =
...
Yes, the plugin comes with a default style, but you can easily customize the chatbot's appearance by editing the chatbot-ultra.css file or adding custom CSS rules to your WordPress theme.
...
Yes, Chatbot Ultra and the chat provider API support many different languages. Set the 'Site Language' option in WordPress to your preference.
...
1. Initial Chatbot Ultra display
2. Ask Chatbot Ultra any question
3. Get a response from Chatbot Ultra
4. Chatbot Ultra running in the embedded mode
5. Mobile Experience - Initial Chatbot Ultra display
6. Mobile Experience - Ask Chatbot ChatGTP any question
7. Mobile Experience - Get a response from Chatbot Ultra
8. Mobile Experience - Chatbot Ultra minimize (Lower Right)
9. Chatbot Ultra shown in Wide mode
...
13. Chatbot Ultra response after running Knowledge Navigator
14. Chatbot Ultra is now more context responsive after running Knowledge Navigator
15. Chatbot Ultra has a deep understanding of your site after running Knowledge Navigator
...
* Use [chatbot_ultra style-"floating" assistant="asst_xxxxxxxxxxxxxxxxxxxxxxxx"] for floating Assistants.
* Use [chatbot_ultra style-"embedded" assistant="asst_xxxxxxxxxxxxxxxxxxxxxxxx"] for embedded Assistants.
* Moved hard coded css from .js to the .css file for floating wide/narrow and embedded styling.
* Fixed Updating Failed JSON error when editing pages where the Chatbot Ultra shortcode appears.

= 1.7.2 =
* Improved Custom GPI Assistants with update thread handling for improved performance.
* Use [chatbot_ultra style=floating assistant=primary] to display the chatbot as floating using your primary assistant.
* Use [chatbot_ultra style=embedded assistant=primary] to display the chatbot as embedded using your primary assistant.
* Use [chatbot_ultra style=floating assistant=alternate] to display the chatbot as floating using your alternate assistant.
* Use [chatbot_ultra style=embedded assistant=alternate] to display the chatbot as embedded using your alternate assistant.
...
* Use [chatbot_ultra] or [chatbot_ultra style=floating] to display the chatbot as a floating chatbot.
* Use [chatbot_ultra style=embedded] to display the chatbot as an embedded chatbot.
...
= 1.6.7 =
* The Chatbot Ultra for WordPress now supports Custom GPTs developed in the OpenAI Playground.
