<?php
/**
 * Chatbot Ultra for WordPress - Globals - Ver 1.6.5
 *
...
$errorResponses = [
    " It seems there may have been an issue with the chat provider API. Let's try again later.",
    " Unfortunately, we might have encountered a problem with the chat provider API. Please give it another shot in a little while.",
    " I apologize, but it appears there's a hiccup with the chat provider API at the moment. We can attempt this again later.",
    " The chat provider API seems to be experiencing difficulties right now. We can come back to this when it's resolved.",
    " I'm sorry, but it seems like there's an error from the chat provider API's side. Please retry in a bit.",
    " There might be a temporary issue with the chat provider API. Please try your request again in a little while.",
    " The chat provider API encountered an error, but don't worry, it happens. Let's give it another shot later.",
    " It looks like there could be a technical problem with the chat provider API. Feel free to try again in a bit to see if things are working smoothly."
];
