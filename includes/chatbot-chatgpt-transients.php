<?php
/**
 * Chatbot Ultra for WordPress - Transients
 *
...
// set_chatbot_ultra_transients( 'file_id', $chatbot_ultra_file_id);
...
function set_chatbot_ultra_transients( $transient_type , $transient_value) {

    // DIAG - Diagnostics
    // chatbot_ultra_back_trace( 'NOTICE', '$transient_type ' . $transient_type);
...
// Get the transients
function get_chatbot_ultra_transients( $transient_type, $user_id, $page_id) {
